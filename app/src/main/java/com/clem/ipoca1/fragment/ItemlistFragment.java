...
import com.clem.ipoca1.activity.FeedInfoActivity;
import com.clem.ipoca1.activity.MainActivity;
import com.clem.ipoca1.adapter.DefaultActionButtonCallback;
import com.clem.ipoca1.adapter.FeedItemlistAdapter;
import com.clem.ipoca1.core.asynctask.FeedRemover;
import com.clem.ipoca1.core.dialog.ConfirmationDialog;
import com.clem.ipoca1.core.dialog.DownloadRequestErrorDialogCreator;
import com.clem.ipoca1.core.event.DownloadEvent;
import com.clem.ipoca1.core.event.DownloaderUpdate;
import com.clem.ipoca1.core.event.FeedItemEvent;
import com.clem.ipoca1.core.feed.EventDistributor;
import com.clem.ipoca1.core.feed.Feed;
import com.clem.ipoca1.core.feed.FeedEvent;
import com.clem.ipoca1.core.feed.FeedItem;
import com.clem.ipoca1.core.feed.FeedItemFilter;
import com.clem.ipoca1.core.feed.FeedMedia;
import com.clem.ipoca1.core.glide.ApGlideSettings;
import com.clem.ipoca1.core.glide.FastBlurTransformation;
...
import com.clem.ipoca1.core.util.gui.MoreContentListFooterUtil;
import com.clem.ipoca1.dialog.EpisodesApplyActionFragment;
import com.clem.ipoca1.dialog.RenameFeedDialog;
import com.clem.ipoca1.menuhandler.FeedItemMenuHandler;
import com.clem.ipoca1.menuhandler.FeedMenuHandler;
...
public class ItemlistFragment extends ListFragment {
    ...
    public static final String EXTRA_SELECTED_FEEDITEM = "extra.com.clem.ipoca1.activity.selected_feeditem";
    public static final String ARGUMENT_FEED_ID = "argument.com.clem.ipoca1.feed_id";
    ...
    private final com.clem.ipoca1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new com.clem.ipoca1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            com.clem.ipoca1.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = com.clem.ipoca1.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

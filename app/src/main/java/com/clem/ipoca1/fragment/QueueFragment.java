...
import com.clem.ipoca1.adapter.QueueRecyclerAdapter;
...
import com.clem.ipoca1.core.util.QueueSorter;
...
public class QueueFragment extends Fragment {
    ...
    private final com.clem.ipoca1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker =
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (queue != null) {
            ...
            com.clem.ipoca1.menuhandler.MenuItemUtils.refreshLockItem(getActivity(), menu);

            isUpdatingFeeds = com.clem.ipoca1.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

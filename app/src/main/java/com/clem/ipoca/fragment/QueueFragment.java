...
import com.clem.ipoca.adapter.QueueRecyclerAdapter;
...
import com.clem.ipoca.core.util.QueueSorter;
...
public class QueueFragment extends Fragment {
    ...
    private final com.clem.ipoca.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker =
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (queue != null) {
            ...
            com.clem.ipoca.menuhandler.MenuItemUtils.refreshLockItem(getActivity(), menu);

            isUpdatingFeeds = com.clem.ipoca.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

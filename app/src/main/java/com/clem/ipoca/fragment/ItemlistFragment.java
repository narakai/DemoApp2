...
import com.clem.ipoca.activity.FeedInfoActivity;
import com.clem.ipoca.activity.MainActivity;
import com.clem.ipoca.adapter.DefaultActionButtonCallback;
import com.clem.ipoca.adapter.FeedItemlistAdapter;
import com.clem.ipoca.core.asynctask.FeedRemover;
import com.clem.ipoca.core.dialog.ConfirmationDialog;
...
import com.clem.ipoca.core.util.gui.MoreContentListFooterUtil;
import com.clem.ipoca.dialog.EpisodesApplyActionFragment;
import com.clem.ipoca.dialog.RenameFeedDialog;
import com.clem.ipoca.menuhandler.FeedItemMenuHandler;
import com.clem.ipoca.menuhandler.FeedMenuHandler;
...
public class ItemlistFragment extends ListFragment {
    ...
    public static final String EXTRA_SELECTED_FEEDITEM = "extra.com.clem.ipoca.activity.selected_feeditem";
    public static final String ARGUMENT_FEED_ID = "argument.com.clem.ipoca.feed_id";
    ...
    private final com.clem.ipoca.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new com.clem.ipoca.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            com.clem.ipoca.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = com.clem.ipoca.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

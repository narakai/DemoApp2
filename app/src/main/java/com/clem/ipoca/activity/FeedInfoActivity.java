...
import com.clem.ipoca.core.feed.FeedFilter;
...
import com.clem.ipoca.core.util.LangUtils;
...
public class FeedInfoActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_FEED_ID = "com.clem.ipoca.extra.feedId";

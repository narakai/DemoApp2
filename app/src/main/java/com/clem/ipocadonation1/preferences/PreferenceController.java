...
import com.clem.ipocadonation1.CrashReportWriter;
import com.clem.ipocadonation1.R;
import com.clem.ipocadonation1.activity.AboutActivity;
import com.clem.ipocadonation1.activity.DirectoryChooserActivity;
import com.clem.ipocadonation1.activity.MainActivity;
import com.clem.ipocadonation1.activity.MediaplayerActivity;
import com.clem.ipocadonation1.activity.PreferenceActivity;
import com.clem.ipocadonation1.activity.PreferenceActivityGingerbread;
import com.clem.ipocadonation1.activity.StatisticsActivity;
import com.clem.ipocadonation1.asynctask.ExportWorker;
import com.clem.ipocadonation1.core.export.ExportWriter;
import com.clem.ipocadonation1.core.export.html.HtmlWriter;
import com.clem.ipocadonation1.core.export.opml.OpmlWriter;
import com.clem.ipocadonation1.core.preferences.GpodnetPreferences;
import com.clem.ipocadonation1.core.preferences.UserPreferences;
import com.clem.ipocadonation1.core.service.GpodnetSyncService;
import com.clem.ipocadonation1.core.util.Converter;
import com.clem.ipocadonation1.core.util.StorageUtils;
import com.clem.ipocadonation1.dialog.AuthenticationDialog;
import com.clem.ipocadonation1.dialog.GpodnetSetHostnameDialog;
import com.clem.ipocadonation1.dialog.ProxyDialog;
import com.clem.ipocadonation1.dialog.VariableSpeedDialog;
...
//        });
        ...
        ui.findPreference(PREF_SEND_CRASH_REPORT).setOnPreferenceClickListener(preference -> {
            ...
            emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"narakai.lai@gmail.com"});
...
//    private void showChooseGenreDialog() {
//
//    }
...
//        final String country = UserPreferences.getPrefCountry();
//        String[] values = res.getStringArray(R.array.country_values);
//        List<String> list = Arrays.asList(values);
//        int selectedIndex = list.indexOf(country);
//        Log.d(TAG, "showChooseCountryDialog: " + selectedIndex);
//
//        MaterialDialog.Builder builder = new MaterialDialog.Builder(context);
//        builder.title(R.string.country_afghanistan_name)
//                .items(R.array.country_options)
//                .alwaysCallSingleChoiceCallback()
//                .itemsCallbackSingleChoice(selectedIndex, new MaterialDialog.ListCallbackSingleChoice() {
//                    @Override
//                    public boolean onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
//                        UserPreferences.setDefaultCountry(list.get(which));
//                        return false;
//                    }
//                });
//        builder.show();

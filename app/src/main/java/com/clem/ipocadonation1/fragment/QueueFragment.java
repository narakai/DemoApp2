...
import com.clem.ipocadonation1.adapter.QueueRecyclerAdapter;
...
import com.clem.ipocadonation1.core.util.QueueSorter;
...
public class QueueFragment extends Fragment {
    ...
    private final com.clem.ipocadonation1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker =
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (queue != null) {
            ...
            com.clem.ipocadonation1.menuhandler.MenuItemUtils.refreshLockItem(getActivity(), menu);

            isUpdatingFeeds = com.clem.ipocadonation1.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

...
import com.clem.ipocadonation1.activity.FeedInfoActivity;
import com.clem.ipocadonation1.activity.MainActivity;
import com.clem.ipocadonation1.adapter.DefaultActionButtonCallback;
import com.clem.ipocadonation1.adapter.FeedItemlistAdapter;
import com.clem.ipocadonation1.core.asynctask.FeedRemover;
import com.clem.ipocadonation1.core.dialog.ConfirmationDialog;
import com.clem.ipocadonation1.core.dialog.DownloadRequestErrorDialogCreator;
import com.clem.ipocadonation1.core.event.DownloadEvent;
import com.clem.ipocadonation1.core.event.DownloaderUpdate;
import com.clem.ipocadonation1.core.event.FeedItemEvent;
import com.clem.ipocadonation1.core.feed.EventDistributor;
import com.clem.ipocadonation1.core.feed.Feed;
import com.clem.ipocadonation1.core.feed.FeedEvent;
import com.clem.ipocadonation1.core.feed.FeedItem;
import com.clem.ipocadonation1.core.feed.FeedItemFilter;
import com.clem.ipocadonation1.core.feed.FeedMedia;
import com.clem.ipocadonation1.core.glide.ApGlideSettings;
import com.clem.ipocadonation1.core.glide.FastBlurTransformation;
import com.clem.ipocadonation1.core.preferences.UserPreferences;
import com.clem.ipocadonation1.core.service.download.DownloadService;
...
import com.clem.ipocadonation1.core.util.FeedItemUtil;
import com.clem.ipocadonation1.core.util.LongList;
import com.clem.ipocadonation1.core.util.gui.MoreContentListFooterUtil;
import com.clem.ipocadonation1.dialog.EpisodesApplyActionFragment;
import com.clem.ipocadonation1.dialog.RenameFeedDialog;
import com.clem.ipocadonation1.menuhandler.FeedItemMenuHandler;
import com.clem.ipocadonation1.menuhandler.FeedMenuHandler;
...
public class ItemlistFragment extends ListFragment {
    ...
    public static final String EXTRA_SELECTED_FEEDITEM = "extra.com.clem.ipocadonation1.activity.selected_feeditem";
    public static final String ARGUMENT_FEED_ID = "argument.com.clem.ipocadonation1.feed_id";
    ...
    private final com.clem.ipocadonation1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new com.clem.ipocadonation1.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            com.clem.ipocadonation1.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = com.clem.ipocadonation1.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }

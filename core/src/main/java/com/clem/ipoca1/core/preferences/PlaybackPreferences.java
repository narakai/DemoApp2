...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    public static final String PREF_CURRENTLY_PLAYING_FEED_ID = "com.clem.ipoca1.preferences.lastPlayedFeedId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "com.clem.ipoca1.preferences.lastPlayedFeedMediaId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_MEDIA = "com.clem.ipoca1.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was streamed.
     */
    public static final String PREF_CURRENT_EPISODE_IS_STREAM = "com.clem.ipoca1.preferences.lastIsStream";

    /**
     * True if last played media was a video.
     */
    public static final String PREF_CURRENT_EPISODE_IS_VIDEO = "com.clem.ipoca1.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    public static final String PREF_CURRENT_PLAYER_STATUS = "com.clem.ipoca1.preferences.currentPlayerStatus";

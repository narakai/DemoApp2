...
import com.clem.ipoca1.core.asynctask.FlattrTokenFetcher;
...
public class FlattrUtils {
    ...
    private static final String HOST_NAME = "com.clem.ipoca1";

    private static final String PREF_ACCESS_TOKEN = "com.clem.ipoca1.preference.flattrAccessToken";

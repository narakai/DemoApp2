package com.clem.ipoca.core.util.flattr;
...
import com.clem.ipoca.core.asynctask.FlattrTokenFetcher;
...
public class FlattrUtils {
    ...
    private static final String HOST_NAME = "com.clem.ipoca";

    private static final String PREF_ACCESS_TOKEN = "com.clem.ipoca.preference.flattrAccessToken";

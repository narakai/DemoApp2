package com.clem.ipoca.core.util.id3reader;
...
import com.clem.ipoca.core.util.id3reader.model.FrameHeader;
import com.clem.ipoca.core.util.id3reader.model.TagHeader;

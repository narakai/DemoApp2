package com.clem.ipoca.core.service.playback;
...
import com.clem.ipoca.core.event.MessageEvent;
...
import com.clem.ipoca.core.feed.SearchResult;
import com.clem.ipoca.core.glide.ApGlideSettings;
import com.clem.ipoca.core.preferences.PlaybackPreferences;
import com.clem.ipoca.core.preferences.SleepTimerPreferences;
import com.clem.ipoca.core.preferences.UserPreferences;
import com.clem.ipoca.core.receiver.MediaButtonReceiver;
...
import com.clem.ipoca.core.storage.FeedSearcher;
import com.clem.ipoca.core.util.IntList;
import com.clem.ipoca.core.util.QueueAccess;
import com.clem.ipoca.core.util.playback.ExternalMedia;
...
public class PlaybackService extends MediaBrowserServiceCompat {
    public static final String FORCE_WIDGET_UPDATE = "com.clem.ipoca.FORCE_WIDGET_UPDATE";
    public static final String STOP_WIDGET_UPDATE = "com.clem.ipoca.STOP_WIDGET_UPDATE";
    /**
     * Logging tag
     */
     ...
     */
    public static final String EXTRA_CAST_DISCONNECT = "extra.com.clem.ipoca.core.service.castDisconnect";
    /**
     * True if media should be streamed.
     */
    public static final String EXTRA_SHOULD_STREAM = "extra.com.clem.ipoca.core.service.shouldStream";
    /**
     * True if playback should be started immediately after media has been
     * prepared.
     */
    public static final String EXTRA_START_WHEN_PREPARED = "extra.com.clem.ipoca.core.service.startWhenPrepared";

    public static final String EXTRA_PREPARE_IMMEDIATELY = "extra.com.clem.ipoca.core.service.prepareImmediately";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.com.clem.ipoca.core.service.playerStatusChanged";
    public static final String EXTRA_NEW_PLAYER_STATUS = "extra.com.clem.ipoca.service.playerStatusChanged.newStatus";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.com.clem.ipoca.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.com.clem.ipoca.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.com.clem.ipoca.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.com.clem.ipoca.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.com.clem.ipoca.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.com.clem.ipoca.core.service.pausePlayCurrentEpisode";


    /**
     * If the PlaybackService receives this action, it will resume playback.
     */
    public static final String ACTION_RESUME_PLAY_CURRENT_EPISODE = "action.com.clem.ipoca.core.service.resumePlayCurrentEpisode";

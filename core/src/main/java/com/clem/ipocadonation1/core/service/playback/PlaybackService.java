package com.clem.ipocadonation1.core.service.playback;
...
import com.clem.ipocadonation1.core.event.MessageEvent;
...
import com.clem.ipocadonation1.core.feed.SearchResult;
import com.clem.ipocadonation1.core.glide.ApGlideSettings;
import com.clem.ipocadonation1.core.preferences.PlaybackPreferences;
import com.clem.ipocadonation1.core.preferences.SleepTimerPreferences;
import com.clem.ipocadonation1.core.preferences.UserPreferences;
import com.clem.ipocadonation1.core.receiver.MediaButtonReceiver;
import com.clem.ipocadonation1.core.storage.DBReader;
import com.clem.ipocadonation1.core.storage.DBTasks;
import com.clem.ipocadonation1.core.storage.DBWriter;
import com.clem.ipocadonation1.core.storage.FeedSearcher;
import com.clem.ipocadonation1.core.util.IntList;
import com.clem.ipocadonation1.core.util.QueueAccess;
import com.clem.ipocadonation1.core.util.playback.ExternalMedia;
import com.clem.ipocadonation1.core.util.playback.Playable;
...
public class PlaybackService extends MediaBrowserServiceCompat {
    public static final String FORCE_WIDGET_UPDATE = "com.clem.ipocadonation1.FORCE_WIDGET_UPDATE";
    public static final String STOP_WIDGET_UPDATE = "com.clem.ipocadonation1.STOP_WIDGET_UPDATE";
    /**
     * Logging tag
     */
     ...
     */
    public static final String EXTRA_CAST_DISCONNECT = "extra.com.clem.ipocadonation1.core.service.castDisconnect";
    /**
     * True if media should be streamed.
     */
    public static final String EXTRA_SHOULD_STREAM = "extra.com.clem.ipocadonation1.core.service.shouldStream";
    /**
     * True if playback should be started immediately after media has been
     * prepared.
     */
    public static final String EXTRA_START_WHEN_PREPARED = "extra.com.clem.ipocadonation1.core.service.startWhenPrepared";

    public static final String EXTRA_PREPARE_IMMEDIATELY = "extra.com.clem.ipocadonation1.core.service.prepareImmediately";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.com.clem.ipocadonation1.core.service.playerStatusChanged";
    public static final String EXTRA_NEW_PLAYER_STATUS = "extra.com.clem.ipocadonation1.service.playerStatusChanged.newStatus";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.com.clem.ipocadonation1.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.com.clem.ipocadonation1.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.com.clem.ipocadonation1.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.com.clem.ipocadonation1.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.com.clem.ipocadonation1.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.com.clem.ipocadonation1.core.service.pausePlayCurrentEpisode";


    /**
     * If the PlaybackService receives this action, it will resume playback.
     */
    public static final String ACTION_RESUME_PLAY_CURRENT_EPISODE = "action.com.clem.ipocadonation1.core.service.resumePlayCurrentEpisode";
            ...
            public void run() {
                ...
                if (android.os.Build.VERSION.SDK_INT >= 11) {
                    if (info.playable != null) {
                        ...
                        try {
                            String url = ((FeedMedia)info.playable).getItem().getFeed().getImage().getDownload_url();
                            Log.d(TAG, "run: " + url);

...
import com.clem.ipocadonation1.core.asynctask.FlattrTokenFetcher;
...
public class FlattrUtils {
    ...
    private static final String HOST_NAME = "com.clem.ipocadonation1";

    private static final String PREF_ACCESS_TOKEN = "com.clem.ipocadonation1.preference.flattrAccessToken";
